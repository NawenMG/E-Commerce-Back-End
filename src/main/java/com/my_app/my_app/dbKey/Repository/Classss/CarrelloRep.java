...
public class CarrelloRep {
    ...
    // Cerca Carrelli in base ai parametri di query
    ...
    DynamoDBQueryExpression<Carrello> queryExpression = new DynamoDBQueryExpression<Carrello>()
    ...
    // Esegui la query
    return dynamoDBMapper.query(Carrello.class, queryExpression);
    }
}
